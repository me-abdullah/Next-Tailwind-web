...
export default function Nutshell() {
    return (
        <div className="relative text-center space-y-4 min-h-[40vh] md:h-[70vh] lg:min-h-[50rem] flex flex-col justify-center items-center text-gray-800 ">
            ...
            <h6 className="text-3xl md:text-4xl font-bold customfont">Subscribe Our Newsletter</h6>
            ...
            <div className="flex gap-4 flex-wrap items-center justify-center ">
                ...
                <button className="text-white bg-gradient-to-tr from-[#d20f2d] to-[#ab182b] px-4 py-2 customfont">Get Started</button>
            </div>
        </div>
    );
}
